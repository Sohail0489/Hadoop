...
SrsSlsPtd = LOAD '/warehouse/map_repo/work/Pos/SywrSrsSlsPtdMstrCrm/20150325' using PigStorage('\u0001') AS(
CreateTs:chararray
...
KmtSlsPtd = LOAD '/warehouse/map_repo/work/Pos/SywrKmtSlsPtdMstrCrm/20150325_new' using PigStorage('\u0001') AS(
CreateTs:chararray
,CustIntractnId:chararray
...
STORE foreach_final into '/warehouse/made/work/Pos/20150325' using PigStorage('\\u0001');

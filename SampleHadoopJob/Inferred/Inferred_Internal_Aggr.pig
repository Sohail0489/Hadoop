...
Inferred_Input = LOAD '/warehouse/made/work/inferred/Segments/20150325' using PigStorage('\\u0001') as
(
...
STORE Inferred_Aggr INTO '/warehouse/made/prod/inferred/Segments/20150408' using PigStorage ('\t');

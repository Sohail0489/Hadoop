...
public class Convert_Json extends EvalFunc<String>{
	public static int j=1;
public String exec(Tuple value) throws IOException, NullPointerException {
//if (value.get(0) == null || ((Tuple) value.get(0)).size() == 0)
	//	return null;
  ...
  try{
	  ...
	  if(input!=null){
	  String[] value_split = input.replaceAll("\\s\\|\\|\\s","||").split("~");
	  String app = "[";
